...
The Pure Comments package comes with a stylesheet that can be used as a starting point for you to customise the look of Pure Comments so it matches the design of your blog.
...
From here you can edit `comments.css` to fit the style of your blog's design. If you choose not to update `comments.css`, this is what Pure Comments will look like:
